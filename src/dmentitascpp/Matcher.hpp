...
{
template <>
struct hash<dmentitascpp::Matcher>
{
	std::size_t operator()(const dmentitascpp::Matcher& matcher) const
	{
...
#define COMPONENT_GET_TYPE_ID(COMPONENT_CLASS) dmentitascpp::ComponentTypeId::Get<COMPONENT_CLASS>()
#define Matcher_AllOf(...) ((dmentitascpp::Matcher)dmentitascpp::Matcher::AllOf(std::vector<dmentitascpp::ComponentId>({ FOR_EACH(COMPONENT_GET_TYPE_ID, __VA_ARGS__) })))
#define Matcher_AnyOf(...) ((dmentitascpp::Matcher)dmentitascpp::Matcher::AnyOf(std::vector<dmentitascpp::ComponentId>({ FOR_EACH(COMPONENT_GET_TYPE_ID, __VA_ARGS__) })))
#define Matcher_NoneOf(...) ((dmentitascpp::Matcher)dmentitascpp::Matcher::NoneOf(std::vector<dmentitascpp::ComponentId>({ FOR_EACH(COMPONENT_GET_TYPE_ID, __VA_ARGS__) })))
}
